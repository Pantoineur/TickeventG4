...
<br><br><br>
      ...
      <form action="requeteModifierTitrePageConcert.php" method="POST">

        <div class="col-3">
          <input type="text" class="form-control" name="titreconcert" placeholder="Titre*" cols="23" rows="5" required></input><br>
        </div>
