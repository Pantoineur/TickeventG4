...
<br><br><br>
      ...
      <form action="requeteAjoutSalleConcert.php" method="POST">

        <div class="col-3">
          <input type="text" class="form-control" name="Nom_salle" placeholder="Nom de la salle*" cols="23" rows="5" required></input><br>
        </div>

        <div class="col-3">
          <input type="text" class="form-control" name="Ville_salle" placeholder="Ville*" cols="23" rows="5" required></input><br>
        </div>

        <div class="col-3">
          <input type="number" class="form-control" name="CP" placeholder="Code Postal*" cols="23" rows="5" required></input><br>
        </div>
