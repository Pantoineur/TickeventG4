...
<br><br><br>
      ...
      <form action="requeteAjoutArtiste.php" method="POST">

        <div class="col-3">
          <input type="text" class="form-control" name="Nom_Artiste" placeholder="Nom Artiste*" cols="23" rows="5" required></input><br>
        </div>
